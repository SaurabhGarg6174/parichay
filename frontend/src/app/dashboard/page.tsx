        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {statCards.map((stat, i) => (
                    <div key={i} className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 transition-all hover:translate-y-[-4px] hover:shadow-md">
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="lg:col-span-2 space-y-8">
                <div className="bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-800 rounded-[2rem] shadow-xl p-10 text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 -mt-20 -mr-20 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
                    <div className="relative z-10">
                        <h2 className="text-3xl font-extrabold mb-3">Hello, {profile?.fullName || 'Member'}!</h2>
                        <p className="text-indigo-100 text-lg mb-8 max-w-md">Find your meaningful connection today. Make sure your bio-data is up to date for better visibility.</p>
                        <div className="flex flex-wrap gap-4">
                            <Link href="/dashboard/profile" className="bg-white text-indigo-700 px-8 py-3.5 rounded-2xl font-bold shadow-soft hover:bg-indigo-50 transition-all hover:scale-105 active:scale-95">
                                {isProfileComplete ? 'Manage My Profile' : 'Create My Bio-data'}
                            </Link>
                            <Link href="/dashboard/matches" className="bg-indigo-500/30 backdrop-blur-md border border-indigo-200/20 text-white px-8 py-3.5 rounded-2xl font-bold hover:bg-indigo-500/40 transition-all hover:scale-105 active:scale-95">
                                Browse Matches
                            </Link>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] shadow-sm border border-gray-100 dark:border-slate-800 group hover:shadow-md transition-all">
                        <div className="flex items-center space-x-5 mb-6">
                            <div className={`${statusInfo.bg} dark:bg-slate-800 p-4 rounded-2xl transition-transform group-hover:scale-110`}>
                            ...
                            <div>
                                ...
                                <p className={`text-sm font-bold uppercase tracking-widest mt-0.5 ${statusInfo.color}`}>{statusInfo.label}</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] shadow-sm border border-gray-100 dark:border-slate-800 group hover:shadow-md transition-all">
                        <div className="flex items-center space-x-5 mb-6">
                            <div className="bg-rose-100 dark:bg-rose-500/10 p-4 rounded-2xl transition-transform group-hover:scale-110">
                                <Heart className="w-8 h-8 text-rose-600" />
                            </div>
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white">Shortlisted</h3>
                                <p className="text-sm font-bold text-gray-500 uppercase tracking-widest mt-0.5">0 Profiles</p>
                            </div>
                        </div>
                        <Link href="/dashboard/matches?tab=shortlisted" className="text-indigo-600 dark:text-indigo-400 font-bold hover:underline flex items-center group">
            ...
            <div className="space-y-8">
                <div className="bg-white dark:bg-slate-900 rounded-[2rem] shadow-sm border border-gray-100 dark:border-slate-800 p-8">
                    ...
                    <div className="space-y-6">
                        <div className="p-5 bg-indigo-50/50 dark:bg-indigo-500/5 rounded-[1.5rem] border border-indigo-100/50 dark:border-indigo-500/10">
                            <p className="font-bold text-gray-900 dark:text-white mb-1 text-sm">Welcome to Parichay!</p>
                            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">Your account has been successfully created. Complete your bio-data to proceed.</p>
                ...
                <div className="bg-indigo-900 rounded-[2rem] p-8 text-white shadow-xl relative overflow-hidden">
                    <div className="relative z-10">
                        ...
                        <p className="text-sm text-indigo-200 mb-6">Our support team is available to help you with profile verification or match assistance.</p>
                        <button className="w-full bg-indigo-500 hover:bg-indigo-400 text-white font-bold py-3 rounded-2xl transition-all">
                            Help Center
                        </button>
                    </div>
                </div>
