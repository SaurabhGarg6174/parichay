...
public class BioDataController {
    ...
    public ResponseEntity<ApiResponse<BioData>> getMyProfile(java.security.Principal principal) {
        return ResponseEntity.ok(
                ApiResponse.success(profileService.getMyBioData(principal.getName()), "Profile fetched successfully"));
    }
    ...
    public ResponseEntity<ApiResponse<BioData>> getProfileById(@PathVariable Long id) {
        return ResponseEntity
                .ok(ApiResponse.success(profileService.getBioDataById(id), "Profile fetched successfully"));
    }
    ...
    public ResponseEntity<ApiResponse<Page<BioData>>> getAllProfiles(
        ...
        return ResponseEntity
                .ok(ApiResponse.success(profileService.getAllBioData(pageable), "Profiles fetched successfully"));
    }
}
